...
| [bundled-backends-migration](./bundled-backends-migration/) | Migration successor to `bundled-backends/`; replaces the bootstrap-shim with native WordPress plugin dependencies (`Requires Plugins: activitypub, atmosphere`) once upstream releases catch up. | in-progress | [DOTCOM-16826](https://linear.app/a8c/issue/DOTCOM-16826) (sub-issues DOTCOM-17180 → 17187) | [#93](https://github.com/Automattic/fosse/pull/93) |
