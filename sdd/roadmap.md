...
| [admin-design-system-alignment](./admin-design-system-alignment/) | Server-rendered Settings/Status design-system alignment without a React rewrite. | shipped | — | [#158](https://github.com/Automattic/fosse/pull/158) |
...
| [bundled-backends-migration](./bundled-backends-migration/) | Migration successor to `bundled-backends/`; pivot to install-if-missing UX for standalone ActivityPub and Atmosphere from WordPress.org. SDD doc merged; implementation not started yet. | in-progress | [DOTCOM-16826](https://linear.app/a8c/issue/DOTCOM-16826) | [#93](https://github.com/Automattic/fosse/pull/93) |
...
| [bundled-backends](./bundled-backends/) | Vendor `wordpress-activitypub` and `wordpress-atmosphere` into FOSSE and auto-load at bootstrap. The "rough starting point" before FOSSE owns its own UI. Successor SDD: [`bundled-backends-migration/`](./bundled-backends-migration/). | [DOTCOM-16799](https://linear.app/a8c/issue/DOTCOM-16799) | [#44](https://github.com/Automattic/fosse/pull/44) and earlier |
