...
| [bundled-backends-migration](./bundled-backends-migration/) | Migration successor to `bundled-backends/`; pivot to install-if-missing UX for standalone ActivityPub and Atmosphere from WordPress.org. SDD doc merged; implementation pending. | in-progress | [DOTCOM-16826](https://linear.app/a8c/issue/DOTCOM-16826) | [#93](https://github.com/Automattic/fosse/pull/93) |
