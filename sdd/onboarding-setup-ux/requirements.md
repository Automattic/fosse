...
2. **Hide all bundled-plugin admin entries** (Settings submenus, top-level Dashboard page, Users submenus) so FOSSE is the single admin surface for federation setup. Pages remain accessible by direct URL for power users.
