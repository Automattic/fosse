...
- **Contrast fixes for 12px wizard text.** `#949494` on white (progress label) → `#707070` (4.74:1, WCAG AA). `#4ab866` on white (is-complete) → `#287340` (5.81:1 on white, 5.34:1 on the `--fosse-wizard-success-soft` `#edf8f1` background — both WCAG AA, stays in the green family). `#757575` on `#f0f0f0` (hint) → `#555` (7.46:1, WCAG AAA).
